            ...
            <div className="grid gap-3 text-xs">
              {(
                [
                  ...
                  ["citySlug", "City slug (URL segment, kebab-case)"],
                  ["countySlug", "County slug (URL segment, kebab-case)"],
                  ["nameSlug", "Restaurant slug (last URL segment; unique with state/county/city)"],
                  ["owner", "Owner"],
                  ["headChef", "Head chef"],
                  ["awards", "Awards"],
