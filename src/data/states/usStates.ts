/** All 50 US states — alphabetical by common name. Slugs are kebab-case for URLs. */

export type USStateRow = { name: string; slug: string; abbr: string };

export const US_STATES_ALPHABETICAL: readonly USStateRow[] = [
